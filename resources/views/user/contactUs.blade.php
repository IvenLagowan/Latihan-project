...
@section('content')
    ...
    {{-- Email contact form --}}
    <div class="d-flex justify-content-end pe-4" style="margin-right: 60px">
        ...
        <form action="{{route('user.contactUs.store')}}" method="post">
          ...
          <div class="message-overlay">
            ...
            <div class="form-floating">
              ...
              <label for="floatingTextarea2">Pijat Anda</label>
            </div>
      
            {{-- search button --}}
            <div class="d-grid gap-2 mt-3">
              <button type="submit" class="btn btn-primary fw-bold fs-5">Kirim Pijat</button>
            </div>
          </form>
      </div>
    </div>
    ...
    <div style="margin-top: 95px; margin-bottom: 100px;">
      ...
      <div class="d-flex justify-content-start gap-5">
        <ul>
          <li><h5>Alamats</h5></li>
          <li><address>A/24/2, Provinsi Papua Tengah</address></li>
        </ul>
    
        <ul>
          <li><h5>Layanan Pelanggan</h5></li>
          <li>(+62)85 245 2212 521</li>
        </ul>
    
        <ul>
          <li><h5>Ikuti Kami Di Sosial Meadia</h5></li>
          <li>
