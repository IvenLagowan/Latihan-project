        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse d-flex ms-5" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll ms-5" style="--bs-scroll-height: 200px;">
              <li class="nav-item">
                <a class="nav-link {{ request()->is('/') ? 'active' : '' }}" aria-current="page" href="{{ route('home') }}">Branda</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ request()->is('package') || request()->is('package/page') ? 'active' : '' }}" href="{{ route('user.travelPackage.show') }}">Tour Travel</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ request()->is('aboutUs') ? 'active' : '' }}" href="{{ route('aboutUs') }}">Tentang Kami</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ request()->is('blog') || request()->is('blogPage') ? 'active' : '' }}" href="{{ route('blog') }}">Blog</a>
              </li>
              <li class="nav-item">
                <a class="nav-link {{ request()->is('contactUs') ? 'active' : '' }}" href="{{ route('contactUs') }}">Kontak Kami</a>
              </li>
            </ul>
