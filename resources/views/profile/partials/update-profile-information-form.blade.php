<div class="d-flex justify-content-between">
    <div>
        <h2 style="margin-top: -10px">Informasi Profil</h2>
        <br>
    </div>
...
<form method="post" action="{{ route('profile.update') }}">
    ...
    {{-- user phone number --}}
    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label fw-semibold">Nomor Telpon</label>
    ...
    {{-- user country --}}
    <div class="mb-3">
        <label for="exampleFormControlInput1" class="form-label fw-semibold"> Negara </label>
