          ...
          <div class="col-md-3 p-4">
            <div class="blog-post-container post-bg">
              ...
              <div class="d-flex justify-content-start gap-1">
                <a href="{{route('admin.editBlog',$blogPost->id)}}" class="btn btn-primary btn-sm">Perbarui</a>
                <a href="{{route('blog.page', $blogPost->id)}}" class="btn btn-secondary btn-sm" target="_blank">Lihat</a>
                
                {{-- button for delete the blog post --}}
                <a href="#" onclick="deleteBlogPost({{ $blogPost->id}});" class="btn btn-danger btn-sm">Hapus</a>
