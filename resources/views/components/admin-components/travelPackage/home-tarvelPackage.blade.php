        ...
        <div class="col-md-3 p-4">
          <div class="travelPackage-bg-container post-bg travelPackage-bg">    
            ...
            <div style="height: 180px;">
                ...
                <h5> 
                    <span class="badge text-bg-warning"> Harga: ${{ $package->price_start_from }} </span>
                </h5>
            </div>
            
            {{-- buttons --}}
            <div class="d-flex justify-content-start gap-1">
              <a href="{{route('admin.editTravelPackage',$package->id)}}" class="btn btn-primary btn-sm">Memperbarui</a>
              <a href="{{route('user.packagePage', $package->id)}}" class="btn btn-secondary btn-sm" target="_blank">Lihat</a>
              
              {{-- button for delete the blog post --}}
              <a href="#" onclick="deleteTravelPackage({{ $package->id}});" class="btn btn-danger btn-sm">Hapus</a>
